...
<div class="p-5 bg-primary text-white text-center">
    <h1 class="text-warning">Riwayat</h1>
</div>
<!-- Navbar -->
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link text-warning fw-bolder" href="{{ route('input_form.history') }}">Riwayat</a>
                </li>
                @auth
                    <li class="nav-item">
...
@endif
    ...
    <div class="container mt-5">
        <h1 class="mb-4">Riwayat Input</h1>
...
<tbody>
    @forelse($inputs as $key => $input)
        <tr>
            ...
            <td>
                <span class="badge 
                    @if ($input->status === 'Tunggu') badge-warning 
                    @elseif ($input->status === 'Diproses') badge-primary 
                    @elseif ($input->status === 'Selesai') badge-success 
                    @endif">
                    {{ $input->status }}
                </span>
            </td>
