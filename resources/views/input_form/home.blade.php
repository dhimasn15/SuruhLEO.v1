...
<h1 class="text-warning">SuruhLEO - Asisten Mahasiswa UPJ</h1>
<p>Solusi cepat untuk berbagai kebutuhanmu di lingkungan kampus!</p>
...
@endif
  @if(session('daftar'))
    <div class="alert alert-warning alert-dismissible fade show m-3" role="alert">
        <strong>{{ session('daftar') }}</strong> <br>
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>
@endif
 ...
 @if(session('login_success'))
    <div class="alert alert-success alert-dismissible fade show m-3" role="alert">
        {{ session('login_success') }} <a href="{{ route('input_form.create') }}" class="alert-link">klik untuk suruh si Leo:)</a>.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>
@endif
...
@if(session('success'))
    <div class="alert alert-success alert-dismissible fade show m-3" role="alert">
        {{ session('success') }}  <a href="{{ route('input_form.history') }}" class="alert-link">klik untuk lihat status bantuan :)</a>.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div>
@endif
 ...
 <section class="bg-dark text-light p-5 p-lg-9 pt-lg-5 text-center text-sm-start">
      <div class="container">
...
<p class="lead my-4">
    Sebagai mahasiswa UPJ, kamu pasti punya banyak kesibukan. SuruhLEO hadir untuk meringankan tugas-tugas kecilmu, 
    mulai dari fotokopi, beli makanan, hingga urusan lainnya di sekitar kampus. Fokus kuliahmu, kami yang urus sisanya!
</p>
            <button class="btn btn-primary btn-lg" data-bs-toggle="tooltip" title="Cobaiinn!!">
              Kita Suruh Leo...
            </button>
          </div>
          <img
...
<!-- card show -->
<div class="card-group p-5 m-5 rounded-4">
  <div class="card m-3 rounded-4">
  <img src="{{ asset('gambar/aset.jpg') }}" class="card-img-top rounded-top-4" alt="Jasa Fotokopi">

    <div class="card-body text-bg-warning rounded-bottom-4">
      <h5 class="card-title">Fotokopi dan Print</h5>
      <p class="card-text">Butuh print tugas mendadak? SuruhLEO siap membantu langsung di kampus.</p>
    </div>
  </div>
  <div class="card m-3 rounded-4">
    <img src="{{ asset('gambar/aset2.jpg') }}" class="card-img-top rounded-top-4" alt="Jasa Belanja">
    <div class="card-body text-bg-warning rounded-bottom-4">
      <h5 class="card-title">Beli Cemilan</h5>
      <p class="card-text">Lagi sibuk tugas? Biarkan kami bantu belikan cemilan di kantin kampus.</p>
    </div>
  </div>
  <div class="card m-3 rounded-4">
    <img src="{{ asset('gambar/aset3.jpg') }}" class="card-img-top rounded-top-4" alt="Jasa Barang">
    <div class="card-body text-bg-warning rounded-bottom-4">
      <h5 class="card-title">Membantu hal lain?</h5>
      <p class="card-text">Nggak sempat beli barang? Tenang, SuruhLEO bisa membelikannya untukmu.</p>
    </div>
  </div>
</div>
...
<!-- Ikuti ini untuk memuat FontAwesome (ikon) jika belum ada -->
